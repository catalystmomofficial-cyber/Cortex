...
declare class AudioContextResumeError extends Error {
    constructor(audioContext: AudioContext, opts: ErrorOptions);
}

export { AudioContextResumeError, AudioInputDevicesStore, AudioModuleRegistrationError, InputAudioEvent, MuteEvent, PCMRecorder, type StartRecordingOptions, UnmuteEvent, getAudioDevicesStore };
