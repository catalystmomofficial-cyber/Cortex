...
class PCMRecorder extends TypedEventTarget {
  constructor(workletScriptURL) {
    ...
    __publicField(this, "workletProcessorNode");
  }
  get analyser() {
  ...
  stopRecording() {
    if (this.mediaStream) {
      ...
      this.workletProcessorNode = void 0;
...
class AudioContextResumeError extends Error {
...
export { AudioContextResumeError, AudioInputDevicesStore, AudioModuleRegistrationError, InputAudioEvent, MuteEvent, PCMRecorder, UnmuteEvent, getAudioDevicesStore };
